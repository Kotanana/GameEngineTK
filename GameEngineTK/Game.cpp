...
void Game::Initialize(HWND window, int width, int height)
{
	...
	*/
	...
	//　モデルの読み込み
	m_modelSkydoom = Model::CreateFromCMO(m_d3dDevice.Get(), L"Resources/skydome.cmo", *m_factorySkydoom);
	m_modelGround = Model::CreateFromCMO(m_d3dDevice.Get(), L"Resources/ground.cmo", *m_factoryGround);
...
void Game::Update(DX::StepTimer const& timer)
{
 ...
 //　ヨー
	...
	for (int i = 0; i < 20; i++)
	{
		...
		Matrix rotateball2 = Matrix::CreateRotationY(XMConvertToRadians(a));
